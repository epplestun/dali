...
$__System.registerDynamic("1", [], false, function(__require, __exports, __module) {
  ...
  (function() {
    ...
    var DataDirectives = this["DataDirectives"];
    ...
    var DataFor = (function() {
      ...
      DataFor = Directive({name: 'data-for'})(DataFor) || DataFor;
      return DataFor;
    })();
    'use strict';
    var _createClass = (function() {
    ...
    var DataIf = (function() {
      ...
      var _DataIf = DataIf;
      DataIf = Directive({name: 'data-if'})(DataIf) || DataIf;
      return DataIf;
    })();
    'use strict';
    var _createClass = (function() {
    ...
    var DataModel = (function() {
      ...
      DataModel = Directive({name: 'data-model'})(DataModel) || DataModel;
      return DataModel;
    })();
    'use strict';
    log('Directive.js');
...
$__System.register('0', ['1', '2', '3', '4', '5'], function (_export) {
  ...
  var bootstrap, Inject, Component, View, Bindable, Runnable, RouterContent, MenuBar, Module1, Module2, Module3, App;
  return {
    setters: [function (_) {
    ...
    execute: function () {
      App = (function () {
        ...
        function App() {
          ...
          babelHelpers.defineDecoratedPropertyDescriptor(this, 'appName', _instanceInitializers);
        }
        ...
        babelHelpers.createDecoratedClass(App, [{
          ...
          initializer: function initializer() {
            return "My Fist DALI App!!";
          },
          enumerable: true
        }], null, _instanceInitializers);
        var _App = App;
        App = Inject(RouterContent, MenuBar)(App) || App;
